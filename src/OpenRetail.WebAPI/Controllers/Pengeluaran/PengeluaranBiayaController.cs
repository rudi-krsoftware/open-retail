...
{        
    ...
    public class PengeluaranBiayaController : BaseApiController, IPengeluaranBiayaController
    {
        ...
        public PengeluaranBiayaController(IUnitOfWork unitOfWork, ILog log)
        {
            this._unitOfWork = unitOfWork;
            this._log = log;
        }
        ...
        public IHttpActionResult GetLastNota()
        {
            ...
            try
            {
                ...
                var obj = _unitOfWork.PengeluaranBiayaRepository.GetLastNota();
        ...
        public IHttpActionResult GetByTanggal(DateTime tanggal_mulai, DateTime tanggal_selesai)
        {
            ...
            try
            {
                var results = _unitOfWork.PengeluaranBiayaRepository.GetByTanggal(tanggal_mulai, tanggal_selesai);
        ...
        public IHttpActionResult GetAll()
        {
            ...
            try
            {
                var results = _unitOfWork.PengeluaranBiayaRepository.GetAll();
        ...
        public IHttpActionResult Save(PengeluaranBiayaDTO objDTO)
        {
            ...
            try
            {
                var obj = AutoMapper.Mapper.Map<PengeluaranBiaya>(objDTO);

                var result = _unitOfWork.PengeluaranBiayaRepository.Save(obj);
        ...
        public IHttpActionResult Update(PengeluaranBiayaDTO objDTO)
        {
            ...
            try
            {
                ...
                var result = _unitOfWork.PengeluaranBiayaRepository.Update(obj);
        ...
        public IHttpActionResult Delete(PengeluaranBiayaDTO objDTO)
        {
            ...
            try
            {
                ...
                var result = _unitOfWork.PengeluaranBiayaRepository.Delete(obj);
