...
{        
    ...
    public class KartuController : BaseApiController, IKartuController
    {
        ...
        public KartuController(IUnitOfWork unitOfWork, ILog log)
        {
            this._unitOfWork = unitOfWork;
            this._log = log;
        }
        ...
        public IHttpActionResult GetAll()
        {
            ...
            try
            {
                var results = _unitOfWork.KartuRepository.GetAll();
        ...
        public IHttpActionResult Save(KartuDTO objDTO)
        {
            ...
            try
            {
                var obj = AutoMapper.Mapper.Map<Kartu>(objDTO);

                var result = _unitOfWork.KartuRepository.Save(obj);
        ...
        public IHttpActionResult Update(KartuDTO objDTO)
        {
            ...
            try
            {
                ...
                var result = _unitOfWork.KartuRepository.Update(obj);
        ...
        public IHttpActionResult Delete(KartuDTO objDTO)
        {
            ...
            try
            {
                ...
                var result = _unitOfWork.KartuRepository.Delete(obj);
