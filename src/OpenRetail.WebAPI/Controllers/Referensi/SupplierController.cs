...
{
    public interface ISupplierController : IBaseApiController<SupplierDTO>
    {
    ...
    public class SupplierController : BaseApiController, ISupplierController
    {
        ...
        public SupplierController(IUnitOfWork unitOfWork, ILog log)
        {
            this._unitOfWork = unitOfWork;
            this._log = log;
        }
        ...
        public IHttpActionResult GetByID(string id)
        {
            ...
            try
            {
                ...
                var obj = _unitOfWork.SupplierRepository.GetByID(id);
        ...
        public IHttpActionResult GetByName(string name)
        {
            ...
            try
            {
                var results = _unitOfWork.SupplierRepository.GetByName(name.NullToString());
        ...
        public IHttpActionResult GetAll()
        {
            ...
            try
            {
                var results = _unitOfWork.SupplierRepository.GetAll();
        ...
        [HttpPost, Route("save")]
        public IHttpActionResult Save(SupplierDTO objDTO)
        {
            _httpStatusCode = HttpStatusCode.BadRequest;
            _response = Content(_httpStatusCode, new ResponsePackage(_httpStatusCode));
            ...
            try
            {
                ...
                var result = _unitOfWork.SupplierRepository.Save(obj);
        ...
        public IHttpActionResult Update(SupplierDTO objDTO)
        {
            _httpStatusCode = HttpStatusCode.BadRequest;
            _response = Content(_httpStatusCode, new ResponsePackage(_httpStatusCode));
            ...
            try
            {
                ...
                var result = _unitOfWork.SupplierRepository.Update(obj);
