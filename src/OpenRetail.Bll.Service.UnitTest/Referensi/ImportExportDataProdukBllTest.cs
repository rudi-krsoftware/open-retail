...
namespace OpenRetail.Bll.Service.UnitTest
{
    ...
    public class ImportExportDataProdukBllTest
    {
        ...
        private const string WorksheetName = "produk";

        [TestInitialize]
        public void Init()
        {
            var fileName = @"D:\Project Non IC\Aplikasi Open Retail\src\OpenRetail.App\bin\Debug\File Import Excel\Master Data\data_produk.xlsx";

            _log = LogManager.GetLogger(typeof(ImportExportDataProdukBllTest));
            _bll = new ImportExportDataProdukBll(fileName, _log);
        }
