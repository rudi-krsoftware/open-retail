...
{
    [TestClass]
    public class PembayaranKasbonWebAPIBllTest
    {
        private ILog _log;
        ...
        public void Init()
        {
            ...
            _log = LogManager.GetLogger(typeof(PembayaranKasbonWebAPIBllTest));
            _bll = new PembayaranKasbonBll(true, baseUrl, _log);
        }
