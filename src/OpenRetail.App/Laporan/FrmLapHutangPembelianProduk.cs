...
{
    public partial class FrmLapHutangPembelianProduk : FrmSettingReportStandard
    {
        private IList<Supplier> _listOfSupplier = new List<Supplier>();
        private ILog _log;

        public FrmLapHutangPembelianProduk(string header)
        {
            InitializeComponent();
        ...
        private void PreviewReportDetail()
        {
            ...
            IList<ReportHutangPembelianProdukDetail> listOfReportHutangPembelian = new List<ReportHutangPembelianProdukDetail>();
            ...
            if (listOfReportHutangPembelian.Count > 0)
            {
                var reportDataSource = new ReportDataSource
                {
                    Name = "ReportHutangPembelianProdukDetail",
                    Value = listOfReportHutangPembelian
                };
                ...
                base.ShowReport(this.Text, "RvHutangPembelianProdukDetail", reportDataSource, parameters);
            }
            else
            {
                MsgHelper.MsgInfo("Maaf laporan data hutang pembelian tidak ditemukan");
