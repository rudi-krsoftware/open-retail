...
{
    public partial class FrmLapCustomerProduk : FrmSettingReportEmptyBody
    {
        private ILog _log;

        public FrmLapCustomerProduk(string header)
        {
            InitializeComponent();
        ...
        private void PreviewReport()
        {
            ...
            IList<ReportCustomerProduk> listOfReport;
            ...
            if (rdoTanggal.Checked)
            {
                ...
                listOfReport = reportBll.CustomerProdukGetByTanggal(dtpTanggalMulai.Value, dtpTanggalSelesai.Value);
            }
            else
            {
                ...
                listOfReport = reportBll.CustomerProdukGetByBulan(bulan, tahun);
            }
