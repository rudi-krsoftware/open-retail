...
{
    public partial class FrmLapPenjualanPerKasir : FrmSettingReportEmptyBody
    {
        private ILog _log;

        public FrmLapPenjualanPerKasir(string header)
        {
            InitializeComponent();
        ...
        private void PreviewReport()
        {
            ...
            IList<ReportPenjualanPerKasir> listOfReportPenjualan;
            ...
            if (rdoTanggal.Checked)
            {
                ...
                listOfReportPenjualan = reportBll.PerKasirGetByTanggal(dtpTanggalMulai.Value, dtpTanggalSelesai.Value);
            }
            else
            {
                ...
                listOfReportPenjualan = reportBll.PerKasirGetByBulan(bulan, tahun);
            }
            ...
            if (listOfReportPenjualan.Count > 0)
            {
                ...
                {
                    Name = "DsReportPenjualanPerKasir",
                ...
                base.ShowReport(this.Text, "RvPenjualanProdukPerKasir", reportDataSource, parameters);
            }
            else
            {
                MsgHelper.MsgInfo("Maaf laporan data penjualan per kasir tidak ditemukan");
            }
        }
    }
}