...
{
    public partial class FrmImportDataCustomer : FrmDialogImport
    {
        private const string ImportTitle = "Customer";
        private ILog _log;

        public IListener Listener { private get; set; }

        public FrmImportDataCustomer(string header)
            : base()
        {
            InitializeComponent();
        ...
        protected override void BrowseFileExcel()
        {
            ...
            using (var dlgOpen = new OpenFileDialog())
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    IImportExportDataBll<Customer> importDataBll = new ImportExportDataCustomerBll(txtPath.Text, _log);
