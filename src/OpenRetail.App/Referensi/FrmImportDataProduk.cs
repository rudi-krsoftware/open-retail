...
namespace OpenRetail.App.Referensi
{
    ...
    {
        private const string ImportTitle = "Produk";
        private ILog _log;

        public IListener Listener { private get; set; }

        public FrmImportDataProduk(string header)
            : base()
        {
            InitializeComponent();
        ...
        protected override void BrowseFileExcel()
        {
            ...
            using (var dlgOpen = new OpenFileDialog())
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    IImportExportDataBll<Produk> importDataBll = new ImportExportDataProdukBll(txtPath.Text, _log);
