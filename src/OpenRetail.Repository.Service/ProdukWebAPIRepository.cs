    ...
    public class ProdukWebAPIRepository : IProdukRepository
    {
        ...
        public Produk GetByID(string id)
        {
			...
			try
            {
                ...
                var response = client.Execute<OpenRetailWebApiGetResponse<Produk>>(request).Data;
        ...
        public Produk GetByKode(string kodeProduk)
        {
            ...
            {
                var client = new RestClient(_apiUrl);
                var request = new RestRequest(string.Format("get_by_kode?kodeProduk={0}", kodeProduk), Method.GET);
                var response = client.Execute<OpenRetailWebApiGetResponse<Produk>>(request).Data;
        ...
        public string GetLastKodeProduk()
        {
            ...
            {
                var client = new RestClient(_apiUrl);
                var request = new RestRequest("get_last_kode_produk", Method.GET);
        ...
        public IList<Produk> GetByName(string name, string sortBy, int pageNumber, int pageSize, ref int pagesCount)
        {
            ...
            try
            {
                ...
                var resource = string.Format("get_by_name_with_paging?name={0}&sortBy={1}&pageNumber={2}&pageSize={3}", name, sortBy, pageNumber, pageSize);
        ...
        public IList<Produk> GetByGolongan(string golonganId)
        {
            ...
            {
                var client = new RestClient(_apiUrl);
                var request = new RestRequest(string.Format("get_by_golongan?golonganId={0}", golonganId), Method.GET);
                var response = client.Execute<OpenRetailWebApiGetResponse<Produk>>(request).Data;
        ...
        public IList<Produk> GetByGolongan(string golonganId, string sortBy, int pageNumber, int pageSize, ref int pagesCount)
        {
            ...
            try
            {
                ...
                var resource = string.Format("get_by_golongan_with_paging?golonganId={0}&sortBy={1}&pageNumber={2}&pageSize={3}", golonganId, sortBy, pageNumber, pageSize);
                var request = new RestRequest(resource, Method.GET);
                var response = client.Execute<OpenRetailWebApiGetResponse<Produk>>(request).Data;
        ...
        public IList<Produk> GetInfoMinimalStok()
        {
            ...
            {
                var client = new RestClient(_apiUrl);
                var request = new RestRequest("get_info_minimal_stok", Method.GET);
                var response = client.Execute<OpenRetailWebApiGetResponse<Produk>>(request).Data;
        ...
        public IList<Produk> GetAll(string sortBy)
        {
            ...
            {
                var client = new RestClient(_apiUrl);
                var request = new RestRequest(string.Format("get_all_sort_by?sortBy={0}", sortBy), Method.GET);
                var response = client.Execute<OpenRetailWebApiGetResponse<Produk>>(request).Data;
        ...
        public IList<Produk> GetAll(string sortBy, int pageNumber, int pageSize, ref int pagesCount)
        {
            ...
            try
            {
                ...
                var resource = string.Format("get_all_with_paging?sortBy={0}&pageNumber={1}&pageSize={2}", sortBy, pageNumber, pageSize);
                var request = new RestRequest(resource, Method.GET);
                var response = client.Execute<OpenRetailWebApiGetResponse<Produk>>(request).Data;
