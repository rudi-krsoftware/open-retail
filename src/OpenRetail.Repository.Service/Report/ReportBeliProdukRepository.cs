    ...
    public class ReportBeliProdukRepository : IReportBeliProdukRepository
    {
        ...
        public IList<ReportPembelianProdukHeader> GetByBulan(int bulan, int tahun)
        {
            ...
            try
            {
                ...
                oList = _context.db.Query<ReportPembelianProdukHeader>(_sql, new { bulan, tahun })
                                .ToList();
            }
            catch (Exception ex)
            {
        ...
        public IList<ReportPembelianProdukHeader> GetByBulan(int bulanAwal, int bulanAkhir, int tahun)
        {
            ...
            try
            {
                ...
                oList = _context.db.Query<ReportPembelianProdukHeader>(_sql, new { bulanAwal, bulanAkhir, tahun })
                                .ToList();
            }
            catch (Exception ex)
            {
        ...
        public IList<ReportPembelianProdukHeader> GetByTanggal(DateTime tanggalMulai, DateTime tanggalSelesai)
        {
            ...
            try
            {
                ...
                oList = _context.db.Query<ReportPembelianProdukHeader>(_sql, new { tanggalMulai, tanggalSelesai })
                                .ToList();
            }
            catch (Exception ex)
            {
        ...
        public IList<ReportPembelianProdukDetail> DetailGetByBulan(int bulan, int tahun)
        {
            ...
            try
            {
                ...
                oList = _context.db.Query<ReportPembelianProdukDetail>(_sql, new { bulan, tahun })
                                .ToList();
            }
            catch (Exception ex)
            {
        ...
        public IList<ReportPembelianProdukDetail> DetailGetByBulan(int bulanAwal, int bulanAkhir, int tahun)
        {
            ...
            try
            {
                ...
                oList = _context.db.Query<ReportPembelianProdukDetail>(_sql, new { bulanAwal, bulanAkhir, tahun })
                                .ToList();
            }
            catch (Exception ex)
            {
        ...
        public IList<ReportPembelianProdukDetail> DetailGetByTanggal(DateTime tanggalMulai, DateTime tanggalSelesai)
        {
            ...
            try
            {
                ...
                oList = _context.db.Query<ReportPembelianProdukDetail>(_sql, new { tanggalMulai, tanggalSelesai })
                                .ToList();
            }
            catch (Exception ex)
            {
