...
namespace OpenRetail.Repository.Service
{
    public class CetakNotaRepository : ICetakNotaRepository
    {
        ...
        public IList<NotaPenjualan> GetNotaPenjualan(string jualProdukId)
        {
            ...
            try
            {
                var sql = @"SELECT m_customer.nama_customer, m_customer.alamat, m_customer.kecamatan, m_customer.kelurahan, m_customer.kota, m_customer.kode_pos, m_customer.kontak, m_customer.telepon, 
                            t_jual_produk.nota, t_jual_produk.tanggal, t_jual_produk.tanggal_tempo, t_jual_produk.ppn, t_jual_produk.ongkos_kirim, t_jual_produk.diskon AS diskon_nota, t_jual_produk.total_nota,
